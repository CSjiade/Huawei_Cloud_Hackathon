...
import com.misa.misa.utils.Constant;
import com.misa.misa.utils.RequestCallback;
import com.misa.misa.utils.Utils;
...
import com.misa.misa.viewmodel.AddFavoriteViewModel;
import com.misa.misa.viewmodel.FromCartViewModel;
import com.misa.misa.viewmodel.RemoveFavoriteViewModel;
import com.misa.misa.viewmodel.ToCartViewModel;
import com.misa.misa.viewmodel.ToHistoryViewModel;
...
public class ProductAdapter extends PagedListAdapter<Product, ProductAdapter.ProductViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, int position) {
        ...
        if (product != null) {
            ...
            holder.binding.txtProductPrice.setText(formattedPrice + " SGD");
            ...
            holder.binding.imgShare.setOnClickListener(v -> Utils.shareProduct(mContext, productName, imageUrl));
    ...
    class ProductViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private void insertFavoriteProduct(RequestCallback callback) {
            Favorite favorite = new Favorite(LoginUtils.getInstance(mContext).getUserInfo().getId(), product.getProductId(),product.getOwnerName());
        ...
        private void insertToCart(RequestCallback callback) {
            Cart cart = new Cart(LoginUtils.getInstance(mContext).getUserInfo().getId(), product.getProductId(),product.getOwnerName());
        ...
        private void insertProductToHistory() {
            History history = new History(LoginUtils.getInstance(mContext).getUserInfo().getId(), product.getProductId(), product.getOwnerName());
