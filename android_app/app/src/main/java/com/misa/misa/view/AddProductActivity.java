...
import com.misa.misa.viewmodel.AddProductViewModel;
...
public class AddProductActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void addProduct(String pathname) {
        ...
        String ageString = binding.txtAge.getText().toString().trim();
        String descriptionString = binding.txtDescription.getText().toString().trim();
        ...
        map.put("age", toRequestBody(ageString));
        map.put("description", toRequestBody(descriptionString));
        map.put("userid", toRequestBody(Integer.toString(userId)));
...
//        map.put("obsimage", requestFile);
//        map.put("filename", toRequestBody(file.getName()));

//        Log.d("aa",requestFile.toString());
//        Log.d("aa",file.getName());

        String token = LoginUtils.getInstance(this).getUserToken();


//        addProductViewModel.addProduct(token,map).observe(this, responseBody -> {
//            try {
