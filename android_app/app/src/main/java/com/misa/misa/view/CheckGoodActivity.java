...
public class CheckGoodActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            tflite=new Interpreter(loadmodelfile(CheckGoodActivity.this));
        }catch (Exception e) {
            e.printStackTrace();
        }
...
//To set components of x axis
    ...
    private void showresult(){
        ...
        try{
            labels = FileUtil.loadLabels(CheckGoodActivity.this,"labels.txt");
        }catch (Exception e){
            e.printStackTrace();
        }
