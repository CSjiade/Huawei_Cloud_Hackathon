...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.SearchViewHolder>{
    ...
    class SearchViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        private void insertFavoriteProduct(RequestCallback callback) {
            Favorite favorite = new Favorite(LoginUtils.getInstance(mContext).getUserInfo().getId(), currentProduct.getProductId(), currentProduct.getOwnerName());
        ...
        private void insertToCart(RequestCallback callback) {
            Cart cart = new Cart(LoginUtils.getInstance(mContext).getUserInfo().getId(), currentProduct.getProductId(), currentProduct.getOwnerName());
        ...
        private void insertProductToHistory() {
            History history = new History(LoginUtils.getInstance(mContext).getUserInfo().getId(), currentProduct.getProductId(), currentProduct.getOwnerName());
