...
import static com.misa.misa.utils.Constant.CAMERA_PERMISSION_CODE;
import static com.misa.misa.utils.Constant.CATEGORY;
import static com.misa.misa.utils.Constant.LOCALHOST;
import static com.misa.misa.utils.Constant.PRODUCT;
import static com.misa.misa.utils.Constant.READ_EXTERNAL_STORAGE_CODE;
import static com.misa.misa.utils.ImageUtils.getImageUri;
import static com.misa.misa.utils.ImageUtils.getRealPathFromURI;
import static com.misa.misa.utils.InternetUtils.isNetworkConnected;
...
import com.misa.misa.receiver.NetworkChangeReceiver;
...
import com.misa.misa.utils.Slide;
import com.misa.misa.viewmodel.HistoryViewModel;
import com.misa.misa.viewmodel.ProductViewModel;
import com.misa.misa.viewmodel.UploadPhotoViewModel;
import com.misa.misa.viewmodel.UserImageViewModel;
...
public class ProductActivity extends AppCompatActivity implements View.OnClickListener, OnNetworkListener, ProductAdapter.ProductAdapterOnClickHandler,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productViewModel.loadLaptops("electronics",userID);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_addProduct:
                ...
                return true;
            case R.id.action_addPrice:
                Intent addPriceIntent = new Intent(this, AddPriceActivity.class);
                startActivity(addPriceIntent);
                return true;

            case R.id.action_checkGood:
                Intent checkGoodIntent = new Intent(this, CheckGoodActivity.class);
                startActivity(checkGoodIntent);
                return true;
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        if (id == R.id.nav_furniture) {
            goToCategoryActivity("furniture");
        } else if (id == R.id.nav_electronic) {
            goToCategoryActivity("electronics");
        } else if (id == R.id.nav_accessories) {
            goToCategoryActivity("accessories");
        } else if (id == R.id.nav_bag) {
            goToCategoryActivity("bags");
